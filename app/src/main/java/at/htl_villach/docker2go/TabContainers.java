...
public class TabContainers extends Fragment implements Connection.onCommandStatusChangeListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        containerArrayAdapter = new ArrayAdapter<DockerContainer>(this.getContext(), R.layout.list_item_container, R.id.textViewContainerName, containers) {
            ...
            public View getView(int position, View v, ViewGroup parent){
                ...
                textViewStatus.setText(currentContainer.getState());
